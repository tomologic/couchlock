...
var binaryTree = &binTree{nil, map[string]*binTree{
	"data": {nil, map[string]*binTree{
		"designs": {nil, map[string]*binTree{
			"locks.json": {dataDesignsLocksJson, map[string]*binTree{}},
		}},
	}},
}}
